...
public class RepositorioTarefaEmOrmTestes : TestFixture
{
    ...
    {
        //Arranjo
        Tarefa tarefa = new Tarefa("Lavar o carro", PrioridadeTarefa.Alta);
    ...
    {
        //Arranjo
        Tarefa tarefaOriginal = new Tarefa("Lavar o carro", PrioridadeTarefa.Alta);

        repositorioTarefa?.CadastrarRegistro(tarefaOriginal);

        Tarefa tarefaEditada = new Tarefa("Lavar a moto", PrioridadeTarefa.Alta);
